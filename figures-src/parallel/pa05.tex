%META {"title":"Cặp góc trong cùng phía bù nhau","note":"Hai góc được đánh dấu nằm cùng phía của đường thẳng c và trong khoảng giữa a, b; tổng của chúng bằng 180° (138° + 42°) → a // b. HS trả lời miệng: hai góc trong cùng phía bù nhau thì hai đường thẳng song song."}
...
\begin{tikzpicture}[line width=1.1pt]
  ...
  \tkzMarkAngles[size=0.55,arc=l,color=tmpink,line width=1pt](P,Q,D)
