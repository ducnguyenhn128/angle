...
\begin{tikzpicture}[line width=1.1pt]
  ...
  \tkzMarkAngles[size=0.6,arc=l,color=tmgreen,line width=1pt](T,O,X)
  \tkzMarkAngles[size=0.6,arc=l,color=tmgreen,line width=1pt](Z,O,T)
  \tkzMarkAngles[size=0.6,arc=ll,color=tmgreen,line width=1pt](U,O,Z)
  \tkzMarkAngles[size=0.6,arc=ll,color=tmgreen,line width=1pt](Y,O,U)
\end{tikzpicture}
\end{document}
