...
Ứng dụng web luyện tập nền tảng hình học THCS dưới dạng mini-game: học sinh chọn cấp độ, trả lờicâu hỏi trắc nghiệm, tích lũy điểm để hoàn thành thử thách. Dành cho giáo viên và học sinh muốn ôn tập nhanh các khái niệm cơ bản như góc nhọn/vuông/tù/bẹt, ước lượng số đo góc, đếm góc, tia/đường thẳng/đoạn thẳng, đường song song, đường vuông góc/đường cao và tia phân giác.

---

## Tính năng chính

- **8 cấp độ** (7 cấp độ cơ bản + 1 cấp độ khó của phần ước lượng góc):
